...
Y={}
Y.lastspell_cast = {spellName = 12, spelltarget = "target"}
Y.1 = {}
Y.1.buff = function (args)
    return args
end

print(Y.lastspell_cast["spellName"])
print(Y.lastspell_cast["spelltarget"])
print(Y.1.cast("spelltarget"))
